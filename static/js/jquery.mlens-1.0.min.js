    ...
    var b = {
        init: function (f) {
            this.each(function () {
                ...
                var m = "background-position: 0px 0px;width: " + String(h.lensSize) + "px;height: " + String(h.lensSize) + "px;float: left;display: none;border: " + String(h.borderSize) + "px solid " + h.borderColor + ";background-repeat: no-repeat;position: absolute;z-index:11";
              alert(111)
                switch (h.lensShape) {
                    case"square":
                    case"":
            ...
            var k = "background-position: 0px 0px;width: " + String(f.lensSize) + "px;height: " + String(f.lensSize) + "px;float: left;display: none;border: " + String(f.borderSize) + "px solid " + f.borderColor + ";background-repeat: no-repeat;position: absolute; z-index:11";
