  ...
  <div class="big clearfix">
    <transition name="bounce">
      <div class="img" v-show="flag">
        <img class="green_monster" :src="src[i]"
             :class="i===0 ? 'class-a' : i===1 ? 'class-b':i===2 ? 'class-c':'class-d'"
             :data-big="src[i]"/>
      </div>
    </transition>
    <img :src="src[i]" width="100%" height="100%" @click="flag=!flag" alt="">
...
<script>
  /* eslint-disable no-undef,quotes,keyword-spacing,semi,space-before-function-paren,one-var,object-curly-spacing,no-unused-vars */
  (function (d) {
    var e = [], a = 0;
    var b = {
      init: function (f) {
  ...
  export default {
    ...
    methods: {
      bigs() {
        ...
        $('.class-a').mlens(
          {
            imgSrc: _this.src[0],	// path of the hi-res version of the image
        ...
        $('.class-b').mlens(
          {
            imgSrc: _this.src[1],	// path of the hi-res version of the image
        ...
        $('.class-c').mlens(
          {
            imgSrc: _this.src[2],	// path of the hi-res version of the image
        ...
        $('.class-d').mlens(
          {
            imgSrc: _this.src[3],	// path of the hi-res version of the image
